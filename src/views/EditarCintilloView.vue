...
<template>
    <h1 class="flex justify-between p-4 font-bold text-gray-800 align-items"><router-link to="/cintillos"><font-awesome-icon :icon="['fas', 'chevron-left']" /> VOLVER</router-link> EDITAR CINTILLO</h1>
