        ...
        <div class="flex flex-wrap mb-6 -mx-3">
          <div class="w-full px-3 mb-6 md:w-1/2 md:mb-0">
            ...
            <div class="flex items-center justify-between">
              ...
              <a class="px-4 py-3 mb-3 leading-tight text-gray-700 bg-gray-200 border rounded-r" @click.prevent="initCameraAndCaptureImage" v-if="usuario == 'VLADI' || usuario === 'CARLOS' || usuario === 'SARAJUAREZ'"><img src="../../public/barcode.png" class="w-[22px] inline-block"></a>
            </div>
