...
Es importante aclarar que la preocupación no proviene de nuestra aplicación, sino de la empresa Callejas. El motivo es la posibilidad de que nuestra aplicación pueda ser utilizada de manera indebida y que la información de precios pueda llegar a manos de competidores u otras cadenas de supermercados.<br><br>
Sin embargo, quiero enfatizar que Multimarcas App es creada y gestionada únicamente por mí. Tanto el desarrollo del backend como del frontend está a mi cargo. Ningun tercero tiene acceso a los datos. Esta información no es pública en la aplicación y solo puede ser enviada a través de ella de manera segura. El escáner de códigos de barras es una función común y no implica riesgos adicionales.<br><br>
Mi intención es mantener la aplicación en funcionamiento sin interrupciones, a menos que sea absolutamente necesario para proteger mi posición laboral y la integridad de los usuarios. Hago un llamado a las entidades y jefes pertinentes en esta área para que analicen minuciosamente el funcionamiento y la seguridad de nuestra aplicación. En caso de hacer caso omiso a las autoridades pertinentes.<br><br>
...
En un último recurso, quiero manifestar que, si las autoridades pertinentes hacen caso omiso a este comunicado, me veré en la necesidad de hacer público el código fuente de mi proyecto, permitiendo que cualquier persona pueda replicar mi aplicación y contribuir a la transparencia en este campo.<br><br>
