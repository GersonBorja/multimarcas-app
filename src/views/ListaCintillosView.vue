          ...
          <div class="bg-white shadow-md">
            ...
            <div class="text-sm border border-solid border-gray-200 border-b-0" v-for="item in datos.slice(inicio, fin)">
              <div
                ...
                <div class="font-medium p-3 flex items-start justify-between">{{ item.descripcion }} <router-link :to="`/editar/${item.uuid}`" v-if="item.uuid" class="font-medium w-[60px]"><font-awesome-icon :icon="['fas', 'pen-to-square']" /> Editar</router-link></div>
